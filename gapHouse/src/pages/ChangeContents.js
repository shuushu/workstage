...
export default function TotalCont() {
  ...
  const nodes = [
    ...
    <p className="parag">
      ...
      달에 한꺼번에 65채를 매수한 적도 있습니다. 2015년 9월부터 2018년 2월까지는
      한 달도 거르지 않고 30개월 연속 매달 집을 샀습니다. 모두 617채, 한 달에
      20채꼴입니다.
    </p>,
    <p className="parag">
    ...
    <p className="parag">
      ...
      임대주택 유형이 확인된 378채 가운데 328채, 87%가 여기에 해당됩니다. 거의
      대부분 취득세를 하나도 안 낸 겁니다.
    </p>,
    <p className="parag">
      재산세는 어떨까요? 임대주택 유형이 확인된 378채 가운데 377채는 재산세를
      50% 이상 감면받았습니다. 종합부동산세는 합산 배제가 가능해 임대주택은 몇
      채든간에 0원입니다.
    </p>,
  ];
