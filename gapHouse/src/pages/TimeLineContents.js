...
export default function TimeLineContents() {
  const nodes = [
    ...
    <p className="parag">
      2019년 4월 첫 압류가 시작됐는데, 2020년 7월까지 총{" "}
      <strong className="강조">8채</strong>를 더 샀습니다.
    </p>,
    <p className="parag">
      세금도 못내고 전세금을 돌려주지 못하는 상황인데도 재산을 늘려간 겁니다.
    </p>,
    <p className="parag">
      집주인 김OO 씨와 어머니 서OO씨가 보유한 주택은 현재{" "}
      <strong className="강조">892채</strong>. 이 가운데{" "}
      <strong className="강조">107채</strong>에서 보증금을 돌려주지 못해 사고가
      발생했습니다.{" "}
      <span className="참고">(2021년 4월 기준, 주택도시보증공사)</span>
    </p>,
    <p className="parag">압류는 계속해서 이어지고 있습니다.</p>,
    <p className="parag">
      전세금 피해 불길도 계속해서 번지고 있습니다.{" "}
      <strong className="강조">
        나쁜 집주인으로 인한 피해는 이제 시작입니다.
      </strong>
    </p>,
  ];
  return (
