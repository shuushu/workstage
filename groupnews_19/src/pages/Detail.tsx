            ...
            if (취득자격증 === 'FALSE' && 경영계획서 === 'FALSE') {
                ...
                return (
                    <div className="context 영농계획뷰">
                        ...
                        { cate === '본인' ? (
                            <><span className="강조"> {name}</span>의원은</>
                        ) : (
                            <><span className="강조"> {name}의원 {cate}</span>는</>
                        )}
                        ...
                        { target["장비 보유현황"].length > 2 && target["장비 보유계획"].length > 2 && target["장비 보유계획2"].length > 2 ? (
                            <div className="장비보유">
                                농업 장비로는 <span className="강조"> {target["장비 보유현황"]}</span>을(를) 갖고 있으며
                                <span className="강조"> {target["장비 보유계획"]}</span>을(를) <span className="강조"> {target["장비 보유계획2"]}</span>로 마련할 계획이라고 밝혔습니다.
